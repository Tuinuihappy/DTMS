...
const toneRing: Record<Kpi["tone"], string> = {
  brand: "from-[var(--color-pastel-sky)] to-[#c7d4ff] text-[var(--color-brand-900)]",
  amber: "from-[var(--color-amber-soft)] to-[#fcd398] text-[#8a4a07]",
  success: "from-[var(--color-success-soft)] to-[#b6e8cf] text-[var(--color-success)]",
  ink: "from-[var(--color-ink-100)] to-[#cfd6e6] text-[var(--color-ink-800)]",
};
