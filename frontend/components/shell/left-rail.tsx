  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Items",
        href: "/delivery-orders/items",
        hint: "Search items across orders",
        requires: Permissions.DeliveryOrder.ItemRead,
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        hint: "Catalog of dtms:* perms",
      },
      {
        icon: <ScrollText className="h-3.5 w-3.5" strokeWidth={2.1} />,
        label: "Audit log",
