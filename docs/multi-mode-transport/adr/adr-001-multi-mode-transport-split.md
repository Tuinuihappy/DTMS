...
- DI registration ที่ [ModuleServiceRegistration.cs:296-299](../../../src/AMR.DeliveryPlanning.Api/Modules/ModuleServiceRegistration.cs#L296-L299) ผูก `IVendorEnvelopeOperationService → Riot3VendorEnvelopeOperationAdapter` ตายตัว
...
- Existing DTMS abstractions: [IVendorEnvelopeOperationService.cs](../../../src/Modules/Dispatch/AMR.DeliveryPlanning.Dispatch.Application/Services/IVendorEnvelopeOperationService.cs)
