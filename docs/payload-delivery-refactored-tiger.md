...
| **P1-5** HandlingInstructions — closed `HandlingInstruction` enum (Fragile / ThisSideUp / DoNotStack / HeavyLift / Sharp / KeepDry / KeepDark / PinchHazard); stored as Postgres `text[]`; duplicate-tolerant; additive integration event | ✅ done | _this commit_ |
...
| 8 | P1-5 handlingInstructions | ✅ | _this commit_ |
