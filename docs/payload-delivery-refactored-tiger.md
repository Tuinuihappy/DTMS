...
| **P1-4** TemperatureRange VO (`MinC`/`MaxC` independently nullable, invariant `MinC ≤ MaxC`) on Item; nullable, additive integration event | ✅ done | _this commit_ |
...
| 7 | P1-4 TemperatureRange VO | ✅ | _this commit_ |
