...
| **P1-10** Amendment snapshot scope — `OrderSnapshotV1` captures full mutable order state (priority, slaTier, serviceWindow, submittedAt, items[] with all VOs); `AmendmentVersion` column (1 = new, 0 = legacy narrow shape) | ✅ done | _this commit_ |
...
| 10 | P1-10 amendment snapshot scope | ✅ | _this commit_ |
