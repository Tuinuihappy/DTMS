...
| **P1-3** HazmatInfo VO (`ClassCode` regex `^[1-9](\.[1-6])?$` + optional `PackingGroup` I/II/III) on Item; nullable, additive integration event | ✅ done | _this commit_ |
...
| 6 | P1-3 HazmatInfo VO | ✅ | _this commit_ |
