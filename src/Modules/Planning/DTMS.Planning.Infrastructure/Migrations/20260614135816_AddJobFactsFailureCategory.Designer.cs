...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTMS.Planning.Domain.Entities.ActionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Planning.Domain.Entities.JobDependency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Planning.Domain.Entities.Leg", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Planning.Infrastructure.Projections.JobStatusHistoryRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Planning.Domain.Entities.Leg", b =>
                {
                    b.HasOne("DTMS.Planning.Domain.Entities.Job", null)
                        .WithMany("Legs")
                        .HasForeignKey("JobId")
