...
namespace AMR.DeliveryPlanning.Planning.Infrastructure.Migrations
{
    ...
    [Migration("20260614135816_AddJobFactsFailureCategory")]
    partial class AddJobFactsFailureCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.Planning.Infrastructure.Projections.JobFactsRow", b =>
                {
                    b.Property<Guid>("JobId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ExecutingAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool?>("SlaDispatchBreached")
                    ...
                    b.HasIndex("SlaDispatchBreached")
                        .HasFilter("\"SlaDispatchBreached\" = true");

                    b.HasIndex("AttemptNumber", "CreatedAt")
                        .HasFilter("\"AttemptNumber\" > 1");

                    b.HasIndex("FailureCategory", "CreatedAt")
