...
public class DeliveryOrderRepository : IDeliveryOrderRepository
{
    ...
    public Task<Domain.Entities.DeliveryOrder?> GetByOrderKeyAsync(string orderKey, CancellationToken cancellationToken = default)
        => _context.DeliveryOrders.FirstOrDefaultAsync(o => o.OrderKey == orderKey, cancellationToken);
