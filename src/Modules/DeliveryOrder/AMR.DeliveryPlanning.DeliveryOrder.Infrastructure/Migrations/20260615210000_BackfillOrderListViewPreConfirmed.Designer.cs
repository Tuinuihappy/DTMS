...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.DeliveryOrder.Infrastructure.Projections.OrderActivityRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.DeliveryOrder.Infrastructure.Projections.OrderFactsRow", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.DeliveryOrder.Infrastructure.Projections.OrderFunnelHourlyRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.DeliveryOrder.Infrastructure.Projections.OrderListViewRow", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AMR.DeliveryPlanning.DeliveryOrder.Domain.Entities.Item", b =>
                {
                    ...
                    b.OwnsOne("AMR.DeliveryPlanning.DeliveryOrder.Domain.ValueObjects.HazmatInfo", "Hazmat", b1 =>
                        {
                            b1.Property<Guid>("ItemId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AMR.DeliveryPlanning.DeliveryOrder.Domain.ValueObjects.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<Guid>("ItemId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AMR.DeliveryPlanning.DeliveryOrder.Domain.ValueObjects.TemperatureRange", "Temperature", b1 =>
                        {
                            b1.Property<Guid>("ItemId")
                                .HasColumnType("uuid");
