...
/// <c>DTMS.Iam.Infrastructure.Callbacks</c> that subscribes to the
/// matching <c>IIntegrationEvent</c>, (d) implement a formatter (or
/// reuse one) for each subscriber that wants the event.</para>
/// </summary>
