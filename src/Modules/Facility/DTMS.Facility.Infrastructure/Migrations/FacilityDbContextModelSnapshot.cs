...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTMS.Facility.Domain.Entities.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Facility.Domain.Entities.Warehouse", b =>
                {
                    b.OwnsOne("DTMS.Facility.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("DTMS.Facility.Domain.ValueObjects.OperatingHours", "Hours", b1 =>
                        {
                            b1.Property<Guid>("WarehouseId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("DTMS.Facility.Domain.ValueObjects.LatLng", "Location", b1 =>
                        {
                            b1.Property<Guid>("WarehouseId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("DTMS.Facility.Domain.ValueObjects.ContactInfo", "PrimaryContact", b1 =>
                        {
                            b1.Property<Guid>("WarehouseId")
                                .HasColumnType("uuid");
