...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.AmrTripExtension", b =>
                {
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.AmrVehicleAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.ExecutionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.ProofOfDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.Trip", b =>
                {
                    ...
                    b.Property<Guid?>("ClaimedByOperatorId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DropWmsLocationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PickupWmsLocationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("VendorDroppedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("VendorPickedUpAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.TripException", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.TripMissionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.TripRetryEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Infrastructure.Projections.TripFactsRow", b =>
                {
                    b.Property<Guid>("TripId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Infrastructure.Projections.TripItemsRow", b =>
                {
                    b.Property<Guid>("TripId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Infrastructure.Projections.TripStatusHistoryRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.AmrTripExtension", b =>
                {
                    b.HasOne("DTMS.Dispatch.Domain.Entities.Trip", null)
                        .WithOne("AmrExtension")
                        .HasForeignKey("DTMS.Dispatch.Domain.Entities.AmrTripExtension", "TripId")
            ...
            modelBuilder.Entity("DTMS.Dispatch.Domain.Entities.AmrVehicleAssignment", b =>
                {
                    b.HasOne("DTMS.Dispatch.Domain.Entities.AmrTripExtension", null)
