...
public record TripCancelledDomainEvent(Guid EventId, DateTime OccurredOn, Guid TripId, string Reason) : IDomainEvent;
...
public record ExceptionRaisedDomainEvent(Guid EventId, DateTime OccurredOn, Guid TripId, Guid ExceptionId, string Code, string Severity) : IDomainEvent;
